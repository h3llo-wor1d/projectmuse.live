                ...
                <div>
                    {
                        ...
                        :
                        <span className="landing-caption">In order to join, please press the button below!<br/></span>
                    }
                    <br/>
                    {
                        localStorage.getItem("discordtoken") !== null ?
    ...
    return (
        <div className="landing-flex">
            ...
            <span className="landing-caption">
                ...
                <div style={{display: "flex", flexDirection: "column", rowGap: "5px", marginTop: "5px"}}>
                    <span>- The show starts with a total of 6 songs. Until those songs are completed, the show will not end.<br/></span>
                    <span>- Payment is completed through the portal on this site which you gain access to after signing in via discord.<br/></span>
                    <span>- Once paid, your Discord account will automatically be added to the Project Muse server.<br/></span>
                </div>
